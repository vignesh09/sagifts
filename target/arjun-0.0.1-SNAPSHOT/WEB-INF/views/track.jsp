...
<body>
	...
	<div class="container">
	  	<div class="row">
	  		<h2 style="color:#1853ba;font-weight:bold;">Enter Details to track</h2>
	  		
	  		<br /><br />
	  		
			<form:form action="trackit" method="GET" >
				<div class="col-md-2">
				</div>
				<div class="col-md-8">
						${alert}
					<div class="form-group" >
	  					...
	  					<input type="text" class="form-control" id="name" name="name" style="width:60%;" required/>
					</div>
					<div class="form-group" >
	  					<label for="email">Email *</label>
	  					<input type="text" class="form-control" id="email" name="email" style="width:60%;" required/>
					</div>
					<div class="form-group" >
	  					<label for="phone">Phone *</label>
	  					<input type="text" class="form-control" id="phone" name="phone" style="width:60%;" required/>
					</div>
					<button type="submit" class="btn btn-lg btn-success">Track</button>
				</div>
			</form:form>
		</div>
	</div>	
