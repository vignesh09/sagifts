...
<body>
	...
	<div class="container">
			...
			<form action="editchoice" method="GET">	
				<div class="form-group" >
	  					<label for="name"><h4>Copy the name of the product and Paste here to edit</h4></label>
	  					<input type="text" name="productName" class="form-control" id="name" style="width:60%;" required="required"/>
				</div>
	...
	<div class="container" >
		 <c:forEach items="${data}" var="list"> 
	               <div class="col-xs-4" style="padding:5%;text-align:center;">   	
	         			<img src="${list.mainurl}.jpg" style="width:100%;"><br />
	        			<h3>${(list.name)}</h3>
	         			<h4>${(list.category)}</h4>
	         			<h5 style="font-weight:bold;">Rs. ${list.price}</h5><br />        
	    			</div>    
		</c:forEach>
	</div>
